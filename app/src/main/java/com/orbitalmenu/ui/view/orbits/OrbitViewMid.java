...
public class OrbitViewMid extends View {
    ...
    public OrbitViewMid(Context context) {
        super(context);
        init(context);
    }

    public OrbitViewMid(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public OrbitViewMid(Context context, AttributeSet attrs, int defStyleAttr) {
