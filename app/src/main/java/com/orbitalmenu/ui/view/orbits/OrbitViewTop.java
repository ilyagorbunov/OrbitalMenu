...
public class OrbitViewTop extends View {
    ...
    public OrbitViewTop(Context context) {
        super(context);
        init(context);
    }

    public OrbitViewTop(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public OrbitViewTop(Context context, AttributeSet attrs, int defStyleAttr) {
